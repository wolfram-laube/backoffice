...
- **Nummerierung** folgt der Epic-Nummer (ADR-027 → Epic #27)
- **Format** nach Bedarf: Markdown für textuelle Entscheidungen, HTML für visuelle Architekturdokumentation
- **Status:** Proposed → Accepted → Superseded
- **Ablage:** `docs/adr/`, Subdirectories für Domänen (z.B. `operations/`)
